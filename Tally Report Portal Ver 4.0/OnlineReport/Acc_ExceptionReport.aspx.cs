...
public partial class OnlineReport_Acc_ExceptionReport : System.Web.UI.Page
{
    ...
    private void GenerateRDLCReport(Report_Search repParamSearch)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlcs/Accounts/Report_ExceptionReport.rdlc");

        DataSet dt = (new Report_DL()).BuildReportData_ExceptionReport(repParamSearch);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else if (lbVoucherType.SelectedIndex == -1)
        {
            string message = "Please Select Voucher from List !!";
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            sb.Append("<script type = 'text/javascript'>");
            sb.Append("window.onload=function(){");
            sb.Append("alert('");
    ...
    protected void ExportCSVReport()
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment; filename=Exception Report." + extension);
