...
public partial class OnlineReport_PendingPurchaseOrder : System.Web.UI.Page
{
    ...
    {
        string ComboName = "StockItem,GodownName";
    ...
    private void GenerateRDLCReport(Report_Search repParamSearch)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlcs/Stock/Report_GodownStockSummary.rdlc");
    ...
    protected void ExportCSVReport()
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment; filename=GodownStockSummary." + extension);
