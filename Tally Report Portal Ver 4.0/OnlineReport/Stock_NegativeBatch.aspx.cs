...
public partial class OnlineReport_Stock_NegativeBatch : System.Web.UI.Page
{
    ...
    private void GenerateRDLCReport(Report_Search repParamSearch)
    {
        ...
        DataSet dt = (new Report_DL()).BuildReportData_NegativeBatchReport(repParamSearch);
    ...
    protected void ExportCSVReport()
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment; filename=NegativeBatch." + extension);
