/****** Script for List Of All Cancelled Vouchers command from SSMS  ******/
...
WHERE TD_Txn_VchHdr.CompanyID = 4 AND  VoucherTypeName = 'Receipts' AND Date = '2020-11-23 00:00:00.000'
AND TD_Txn_VchHdr.PartyLedgerName = TD_Txn_AccLine.LedgerName
AND IsOptional = 1