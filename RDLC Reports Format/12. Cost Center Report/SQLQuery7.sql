SELECT DISTINCT VH.Date as [Date], vh.CostCentreName , VH.PartyLedgerName as [LedgerName], '' as [Particular], VH.VoucherTypeName as [VoucherType], VH.VoucherNo as [VoucherNo],
...
Select Top(10) * from TD_Txn_VchHdr where CompanyID=4