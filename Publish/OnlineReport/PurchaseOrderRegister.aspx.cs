...
public partial class OnlineReport_PurchaseOrderRegister : System.Web.UI.Page
{
    ...
    {
        string ComboName = "VendorName,StockItem,PONumber";
    ...
    private void GenerateRDLCReport(Report_Search repParamSearch)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlcs/Purchase/Report_PurchaseOrderRegister.rdlc");

        DataSet dt = (new Report_DL()).BuildReportData_PurchaseOrderRegister(repParamSearch);
        if (dt !=null)
        {
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource()
            {
                Name = "dsPurchaseOrderRegister",
                Value = dt.Tables[0]
            });
        }
    ...
    protected void ExportCSVReport()
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment; filename=PurchaseOrderRegister." + extension);
