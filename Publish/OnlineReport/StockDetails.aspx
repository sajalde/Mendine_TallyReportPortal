<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StockDetails.aspx.cs" Inherits="OnlineReport_StockDetails" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:ListBox ID="lbVoucherType" runat="server" SelectionMode="Multiple" class="form-control"></asp:ListBox>
                                    </div>
                                </div>
                            </div>
                        </div>
