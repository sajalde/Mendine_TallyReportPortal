...
public partial class OnlineReport_Acc_LedgerReport : System.Web.UI.Page
{
    ...
    private void GenerateRDLCReport(Report_Search repParamSearch)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rdlcs/Accounts/Report_LedgerReport.rdlc");

        DataSet dt = (new Report_DL()).BuildReportData_LedgerReport(repParamSearch);
